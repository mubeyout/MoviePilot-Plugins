...
const _sfc_main$q = /* @__PURE__ */ _defineComponent$q({
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function deleteRule(priority) {
      loading.value = true;
      try {
        await props.api.delete(`/plugin/MubeyClashRP/rules/ruleset/${priority}`);
        emit("refresh", ["top", "ruleset"]);
      } catch (err) {
        if (err instanceof Error) {
    ...
    async function deleteRules(priorities) {
      loading.value = true;
      try {
        await props.api.delete("/plugin/MubeyClashRP/rules/ruleset", {
    ...
    async function handleReorderRule(targetPriority, movedPriority) {
      loading.value = true;
      try {
        await props.api.put(`/plugin/MubeyClashRP/reorder-rules/ruleset/${targetPriority}`, {
    ...
    async function handleStatusChange(priority, disabled) {
      loading.value = true;
      try {
        await props.api.post(`/plugin/MubeyClashRP/rules/ruleset/metadata/disabled`, {
          [priority]: disabled
        });
        emit("refresh", ["top", "ruleset"]);
      } catch (err) {
    ...
    async function handleBatchStatusChange(priorities, disabled) {
      ...
      try {
        ...
        await props.api.post(`/plugin/MubeyClashRP/rules/ruleset/metadata/disabled`, payload);
        emit("refresh", ["top", "ruleset"]);
      } catch (err) {
        if (err instanceof Error) {
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function saveHost() {
      ...
      try {
        ...
        const result = await props.api.post("/plugin/MubeyClashRP/hosts", {
          domain: targetDomain,
          host: newHost.value
        });
        if (!result.success) {
...
const _sfc_main$2 = /* @__PURE__ */ _defineComponent$2({
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function deleteHost(name) {
      loading.value = true;
      try {
        await props.api.delete(`/plugin/MubeyClashRP/hosts/${encodeURIComponent(name)}`);
        emit("refresh");
      } catch (err) {
...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function refreshRulesetRules() {
      const response = await props.api.get("/plugin/MubeyClashRP/rules/ruleset");
    ...
    async function refreshHosts() {
      const hostsResponse = await props.api.get("/plugin/MubeyClashRP/hosts");
    ...
    async function refreshData() {
      ...
      try {
        const [
          ...
          props.api.get("/plugin/MubeyClashRP/rules/ruleset"),
          ...
          props.api.get("/plugin/MubeyClashRP/hosts"),
